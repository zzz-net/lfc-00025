...
import {
  ...
  ChevronDown, ChevronUp, RefreshCw, Share2,
} from 'lucide-react';
import { cn } from '@/lib/utils';
import { ANOMALY_TYPE_LABELS, ANOMALY_TYPE_COLORS } from '../../../shared/types.js';
import type { ThresholdConfig, SandboxAnomaly } from '../../../shared/types.js';
      ...
      <header className="h-16 shrink-0 bg-white/80 backdrop-blur border-b border-slateqc-100 flex items-center px-6 gap-4 sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-24 px-3 py-1.5 text-xs border border-slateqc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-blue/30"
          />
          ...
          {editing ? (
            ...
            <>
              ...
              <button onClick={handleCheckPublish} className="btn-primary text-xs flex items-center gap-1.5">
          ...
          {!currentPlayback || !comparisonResult ? (
            ...
            <>
              ...
              <div className="flex items-center gap-2 mb-3 border-b border-slateqc-100">
                {(['overview', 'anomalies'] as const).map((tab) => (
                  <button
                    key={tab}
